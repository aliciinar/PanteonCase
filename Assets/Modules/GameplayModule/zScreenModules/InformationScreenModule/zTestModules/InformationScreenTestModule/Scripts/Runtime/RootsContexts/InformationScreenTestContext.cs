...
namespace Modules.GameplayModule.InformationScreenModule.InformationScreenTestModule.RootsContexts
{
    /// <summary>
    ...
    public class InformationScreenTestContext : BaseScreenContext
    {
        public override void Launch()
        {
            base.Launch();
			_screenService.Open<InformationScreenView>().Show();
